...
namespace neu
{
	...
	Vector2 PhysicsSystem::WorldToScreen(const Vector2& world) { return world * pixelsPerUnit; }
	Vector2 PhysicsSystem::ScreenToWorld(const Vector2& screen) { return screen * (1.0f / pixelsPerUnit); }
