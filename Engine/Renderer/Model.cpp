...
namespace neu
{
	...
	void Model::Draw(neu::Renderer& renderer, const neu::Vector2& position, float angle, const Vector2& scale)
	{
	...
	void Model::Draw(neu::Renderer& renderer, const Transform& transform)
	{
